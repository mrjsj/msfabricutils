...
def kql_queryset_create(
    ...
    Args:
        workspace_id (str): The id of the workspace to create the kql queryset in.
        display_name (str): The display name of the kql queryset.
        kql_database_path (str): The path to the kql queryset to load content from.
        description (str | None): The description of the kql queryset.
    ...
    url = f"https://api.fabric.microsoft.com/v1/workspaces/{workspace_id}/kqlQuerysets"  # noqa
    url = f"{url}?"
    url = url.rstrip("&?")
    ...
    with open(kql_database_path.rstrip("/") + "/RealtimeQueryset.json", "r") as f:
        RealtimeQueryset = base64.b64encode(f.read().encode()).decode()
...
def kql_queryset_get(
    ...
    Args:
        workspace_id (str): The id of the workspace to get the kql queryset from.
        kql_queryset_id (str): The id of the kql queryset to get.
        preview (bool): Whether to preview the request. You will be asked to confirm the request before it is executed. Defaults to True.
    ...
    url = f"https://api.fabric.microsoft.com/v1/workspaces/{workspace_id}/kqlQuerysets/{kql_queryset_id}"  # noqa
    url = f"{url}?"
    url = url.rstrip("&?")
...
def kql_queryset_list(
    ...
    Args:
        workspace_id (str): The id of the workspace to list kql querysets for.
...
def kql_queryset_update(
    ...
    Args:
        ...
        kql_queryset_id (str): The id of the kql queryset to update.
        display_name (str | None): The display name of the kql queryset.
        description (str | None): The description of the kql queryset.
        preview (bool): Whether to preview the request. You will be asked to confirm the request before it is executed. Defaults to True.
...
def kql_queryset_delete(
    ...
    Args:
        ...
        kql_queryset_id (str): The id of the kql queryset to delete.
        preview (bool): Whether to preview the request. You will be asked to confirm the request before it is executed. Defaults to True.
...
def kql_queryset_get_definition(
    workspace_id: str,
    kql_queryset_id: str,
    await_lro: bool = None,
    timeout: int = 60 * 5,
    ...
    Args:
        workspace_id (str): The id of the workspace to get the kql queryset definition from.
        kql_queryset_id (str): The id of the kql queryset to get the definition from.
        await_lro (bool | None): Whether to await the long running operation.
        timeout (int): Timeout for the long running operation (seconds). Defaults to 5 minutes.
        preview (bool): Whether to preview the request. You will be asked to confirm the request before it is executed. Defaults to True.
    ...
    url = f"https://api.fabric.microsoft.com/v1/workspaces/{workspace_id}/kqlQuerysets/{kql_queryset_id}/getDefinition"  # noqa
    url = f"{url}?"
    url = url.rstrip("&?")
...
def kql_queryset_update_definition(
    workspace_id: str,
    kql_queryset_id: str,
    kql_queryset_path: str,
    ...
    Args:
        workspace_id (str): The id of the workspace to update.
        kql_queryset_id (str): The id of the kql queryset to update.
        kql_queryset_path (str): The path to the kql queryset to load content from.
    ...
    url = f"https://api.fabric.microsoft.com/v1/workspaces/{workspace_id}/kqlQuerysets/{kql_queryset_id}/updateDefinition"  # noqa
    url = f"{url}?"
    ...
    with open(kql_queryset_path.rstrip("/") + "/RealtimeQueryset.json", "r") as f:
        RealtimeQueryset = base64.b64encode(f.read().encode()).decode()

    with open(kql_queryset_path.rstrip("/") + "/.platform", "r") as f:
        platform = base64.b64encode(f.read().encode()).decode()

...
def list_workspace_access_details_command(
    *,
    workspace_id: str,
    ...
    """Execute list_workspace_access_details command
    ...
    try:
        ...
        result = client.list_workspace_access_details(workspace_id=workspace_id)

...
def revoke_command(
    *,
    ...
    try:
        ...
        result = client.revoke_external_data_share(external_data_share_id=external_data_share_id, item_id=item_id, workspace_id=workspace_id)

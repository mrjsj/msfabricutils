...
def list_capacities_tenant_settings_overrides_command(
    *,
    ...
    """Execute list_capacities_tenant_settings_overrides command"""
    try:
        # time.sleep(1)
        from msfabricpysdkcore import FabricClientAdmin

        client = FabricClientAdmin()
        result = client.list_capacities_tenant_settings_overrides()

...
def assign_workspaces_by_ids_command(
    *,
    domain_id: str,
    ...
    """Execute assign_workspaces_by_ids command

    Args:
        domain_id (str): The ID of the domain
        workspaces_ids (List[str]): The list of workspace IDs
    """
    ...
    try:
        ...
        result = client.assign_domain_workspaces_by_ids(domain_id=domain_id, workspaces_ids=workspaces_ids)

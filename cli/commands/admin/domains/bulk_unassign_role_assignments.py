...
def bulk_unassign_role_assignments_command(
    *,
    domain_id: str,
    ...
    """Execute bulk_unassign_role_assignments command
    ...
    try:
        ...
        result = client.role_assignments_bulk_unassign(domain_id=domain_id, type=type, principals=principals)

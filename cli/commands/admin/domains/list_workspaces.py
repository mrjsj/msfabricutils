...
def list_workspaces_command(
    *,
    domain_id: str,
    workspace_objects: bool,
    ...
    """Execute list_workspaces command

    Args:
        domain_id (str): The ID of the domain
        workspace_objects (bool): Whether to return as objects
    """
    try:
        # time.sleep(1)
        ...
        result = client.list_domain_workspaces(domain_id=domain_id, workspace_objects=workspace_objects)

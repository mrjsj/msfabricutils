...
def list_access_details_command(
    *,
    workspace_id: str,
    item_id: str,
    type: ItemType,
    ...
    """Execute list_access_details command
    ...
    try:
        ...
        result = client.list_item_access_details(workspace_id=workspace_id, item_id=item_id, type=type)

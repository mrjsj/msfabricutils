...
def list_data_access_roles_command(
    *,
    workspace_id: str,
    item_id: str,
    ...
    """Execute list_data_access_roles command
    ...
    try:
        ...
        result = client.list_data_access_roles(workspace_id=workspace_id, item_id=item_id)

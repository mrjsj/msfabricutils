...
def get_command(
    *,
    ...
    try:
        ...
        result = client.get_kql_dashboard(workspace_id=workspace_id, kql_dashboard_id=kql_dashboard_id, kql_dashboard_name=kql_dashboard_name)

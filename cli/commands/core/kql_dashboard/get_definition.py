...
def get_definition_command(
    *,
    ...
    Args:
        ...
        format (str): The format of the kql dashboard
    """
    try:
        # time.sleep(1)
        ...
        result = client.get_kql_dashboard_definition(workspace_id=workspace_id, kql_dashboard_id=kql_dashboard_id, format=format)

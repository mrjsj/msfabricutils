...
def update_command(
    *,
    ...
    try:
        ...
        result = client.update_kql_dashboard(
            workspace_id=workspace_id, kql_dashboard_id=kql_dashboard_id, display_name=display_name, description=description, return_item=return_item
        )

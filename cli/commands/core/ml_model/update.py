...
def update_command(
    *,
    ...
    try:
        ...
        result = client.update_ml_model(
            workspace_id=workspace_id, ml_model_id=ml_model_id, display_name=display_name, description=description, return_item=return_item
        )

...
def unassign_from_capacity_command(
    *,
    workspace_id: str,
    ...
    """Execute unassign_from_capacity command
    ...
    try:
        ...
        result = client.unassign_from_capacity(workspace_id=workspace_id, wait_for_completion=wait_for_completion)

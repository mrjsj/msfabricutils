...
def update_definition_command(
    *,
    ...
    format: Annotated[Literal["ipynb"], Parameter(help="The format of the notebook")],
    ...
    Args:
        ...
        definition (ItemDefinition): The definition of the notebook
        format (Annotated[Literal["ipynb"], Parameter(help="The format of the notebook")]): The format of the notebook
    """
    ...
    try:
        ...
        result = client.update_notebook_definition(workspace_id=workspace_id, notebook_id=notebook_id, definition=definition)

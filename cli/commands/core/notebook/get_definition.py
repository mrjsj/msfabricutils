...
def get_definition_command(
    *,
    ...
    format: Annotated[Literal["ipynb"], Parameter(help="The format of the definition")] = None,
    ...
    Args:
        ...
        format (Annotated[Literal["ipynb"], Parameter(help="The format of the definition")] = None): The format of the definition
    """

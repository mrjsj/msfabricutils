...
def create_command(
    *,
    workspace_id: str,
    display_name: str,
    definition: Annotated[ItemDefinition, Parameter(name="*",help="The definition of the notebook")],
    description: str,
    ...
    try:
        if isinstance(definition, ItemDefinition):
            definition = ItemDefinition(file_path=definition.file_path).from_path(format=format).to_dict()

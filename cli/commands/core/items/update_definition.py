...
def update_definition_command(
    *,
    ...
    Args:
        ...
        wait_for_completion (bool): Whether to wait for the item to be updated
    """
    ...
    try:
        ...
        result = client.update_item_definition(
            workspace_id=workspace_id, item_id=item_id, definition=definition, type=type, wait_for_completion=wait_for_completion
        )

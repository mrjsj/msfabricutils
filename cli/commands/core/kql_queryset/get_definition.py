...
def get_definition_command(
    *,
    ...
    Args:
        ...
        format (str): The format of the kql queryset
    """
    ...
    try:
        ...
        result = client.get_kql_queryset_definition(workspace_id=workspace_id, kql_queryset_id=kql_queryset_id, format=format)

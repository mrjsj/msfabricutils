...
def update_command(
    *,
    ...
    try:
        ...
        result = client.update_kql_queryset(
            workspace_id=workspace_id, kql_queryset_id=kql_queryset_id, display_name=display_name, description=description, return_item=return_item
        )

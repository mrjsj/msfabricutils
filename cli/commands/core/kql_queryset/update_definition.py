...
def update_definition_command(
    *,
    ...
    Args:
        ...
        definition (ItemDefinition): The definition of the kql queryset
    ...
    try:
        ...
        result = client.update_kql_queryset_definition(
            workspace_id=workspace_id, kql_queryset_id=kql_queryset_id, definition=definition, update_metadata=update_metadata
        )

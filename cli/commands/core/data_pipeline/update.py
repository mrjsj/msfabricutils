...
def update_command(
    *,
    ...
    try:
        ...
        result = client.update_data_pipeline(
            workspace_id=workspace_id, data_pipeline_id=data_pipeline_id, display_name=display_name, description=description, return_item=return_item
        )

...
def create_command(
    *,
    ...
    Args:
        ...
        definition (ItemDefinition): The definition of the data pipeline
    ...
    try:
        ...
        result = client.create_data_pipeline(workspace_id=workspace_id, display_name=display_name, definition=definition, description=description)

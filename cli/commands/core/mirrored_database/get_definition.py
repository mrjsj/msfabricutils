...
def get_definition_command(
    *,
    ...
    format: Annotated[str, Parameter(help="The format of the item", show=False)],
    ...
    Args:
        ...
        format (Annotated[str, Parameter(help="The format of the item", show=False)]): The format of the item
    """
    ...
    try:
        ...
        result = client.get_mirrored_database_definition(workspace_id=workspace_id, mirrored_database_id=mirrored_database_id)

...
def get_tables_status_command(
    *,
    ...
    """Execute get_tables_status command
    ...
    try:
        ...
        result = client.get_tables_mirroring_status(workspace_id=workspace_id, mirrored_database_id=mirrored_database_id)

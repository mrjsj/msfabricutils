...
def update_command(
    *,
    ...
    Args:
        ...
        connection_request (ConnectionRequest): The connection request
    """
    ...
    try:
        ...
        result = client.update_connection(connection_id=connection_id, connection_request=connection_request)

...
def update_role_assignment_command(
    *,
    connection_id: str,
    ...
    """Execute update_role_assignment command
    ...
    try:
        ...
        result = client.update_connection_role_assignment(
            connection_id=connection_id, connection_role_assignment_id=connection_role_assignment_id, role=role
        )

...
def update_command(
    *,
    ...
    try:
        ...
        result = client.update_kql_database(
            workspace_id=workspace_id, kql_database_id=kql_database_id, display_name=display_name, description=description, return_item=return_item
        )

...
def get_command(
    *,
    ...
    try:
        ...
        result = client.get_ml_experiment(workspace_id=workspace_id, ml_experiment_id=ml_experiment_id, ml_experiment_name=ml_experiment_name)

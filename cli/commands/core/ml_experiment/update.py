...
def update_command(
    *,
    ...
    try:
        ...
        result = client.update_ml_experiment(
            workspace_id=workspace_id, ml_experiment_id=ml_experiment_id, display_name=display_name, description=description, return_item=return_item
        )

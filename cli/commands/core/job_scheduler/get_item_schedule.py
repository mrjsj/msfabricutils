...
def get_item_schedule_command(
    *,
    ...
    """Execute get_item_schedule command
    ...
    try:
        ...
        result = client.get_item_schedule(workspace_id=workspace_id, item_id=item_id, job_type=job_type, schedule_id=schedule_id)

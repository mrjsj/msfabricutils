...
def create_item_schedule_command(
    *,
    workspace_id: str,
    item_id: str,
    job_type: str,
    configuration: Annotated[ScheduleConfig, Parameter(name="*")],
    enabled: bool,
    ...
    """Execute create_item_schedule command

    Args:
        workspace_id (str): The ID of the workspace
        item_id (str): The ID of the item
        job_type (str): The type of the job
        configuration (Annotated[ScheduleConfig, Parameter(name="*")]): The configuration of the schedule
    ...
    try:
        ...
        result = client.create_item_schedule(
            workspace_id=workspace_id, item_id=item_id, job_type=job_type, configuration=configuration, enabled=enabled
        )

...
def list_item_job_instances_command(
    *,
    workspace_id: str,
    item_id: str,
    ...
    """Execute list_item_job_instances command
    ...
    try:
        ...
        result = client.list_item_job_instances(workspace_id=workspace_id, item_id=item_id)

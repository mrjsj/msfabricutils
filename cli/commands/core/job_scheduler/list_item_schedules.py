...
def list_item_schedules_command(
    *,
    workspace_id: str,
    item_id: str,
    job_type: str,
    ...
    """Execute list_item_schedules command
    ...
    try:
        ...
        result = client.list_item_schedules(workspace_id=workspace_id, item_id=item_id, job_type=job_type)

...
def get_item_job_instance_command(
    *,
    workspace_id: str,
    item_id: str,
    job_instance_id: str,
    ...
    """Execute get_item_job_instance command
    ...
    try:
        ...
        result = client.get_item_job_instance(workspace_id=workspace_id, item_id=item_id, job_instance_id=job_instance_id)

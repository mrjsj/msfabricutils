...
def update_command(
    *,
    ...
    try:
        ...
        result = client.update_eventstream(
            workspace_id=workspace_id, eventstream_id=eventstream_id, display_name=display_name, description=description, return_item=return_item
        )

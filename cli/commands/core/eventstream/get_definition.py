...
def get_definition_command(
    *,
    ...
    Args:
        ...
        format (str): The format of the eventstream
    """
    try:
        # time.sleep(1)
        ...
        result = partial(client.get_item_definition, type="eventstreams")(workspace_id=workspace_id, item_id=eventstream_id, format=format)

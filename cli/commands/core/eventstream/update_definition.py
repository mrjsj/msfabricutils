...
def update_definition_command(
    *,
    ...
    Args:
        ...
        item_id (str): The ID of the eventstream
        definition (ItemDefinition): The definition of the eventstream
    ...
    try:
        ...
        result = partial(client.update_item_definition, type="eventstreams")(
            workspace_id=workspace_id, item_id=eventstream_id, definition=definition, update_metadata=update_metadata
        )

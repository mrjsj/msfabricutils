...
def get_definition_command(
    *,
    ...
    Args:
        ...
        item_id (str): The ID of the eventhouse
        item_path (Annotated[OutFile, Parameter(name="*")]): The path of the eventhouse definition
        format (str): The format of the eventhouse
    """
    ...
    try:
        ...
        result = partial(client.get_item_definition, type="eventhouses")(workspace_id=workspace_id, item_id=eventhouse_id, format=format)

...
def update_command(
    *,
    ...
    try:
        ...
        result = client.update_eventhouse(
            workspace_id=workspace_id, eventhouse_id=eventhouse_id, display_name=display_name, description=description, return_item=return_item
        )

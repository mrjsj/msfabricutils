...
def update_command(
    *,
    ...
    try:
        ...
        result = client.update_lakehouse(
            workspace_id=workspace_id, lakehouse_id=lakehouse_id, display_name=display_name, description=description, return_item=return_item
        )

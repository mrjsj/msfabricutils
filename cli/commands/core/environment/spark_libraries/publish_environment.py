...
def publish_environment_command(
    *,
    workspace_id: str,
    environment_id: str,
    ...
    """Execute publish_environment command
    ...
    try:
        ...
        result = client.publish_environment(workspace_id=workspace_id, environment_id=environment_id)

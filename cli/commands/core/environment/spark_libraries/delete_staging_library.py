...
def delete_staging_library_command(
    *,
    workspace_id: str,
    environment_id: str,
    ...
    """Execute delete_staging_library command
    ...
    try:
        ...
        result = client.delete_staging_library(workspace_id=workspace_id, environment_id=environment_id, library_to_delete=library_to_delete)

...
def get_staging_libraries_command(
    *,
    workspace_id: str,
    environment_id: str,
    ...
    """Execute get_staging_libraries command
    ...
    try:
        ...
        result = client.get_staging_libraries(workspace_id=workspace_id, environment_id=environment_id)

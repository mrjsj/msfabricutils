...
def get_published_libraries_command(
    *,
    workspace_id: str,
    environment_id: str,
    ...
    """Execute get_published_libraries command
    ...
    try:
        ...
        result = client.get_published_libraries(workspace_id=workspace_id, environment_id=environment_id)

...
def get_staging_settings_command(
    *,
    workspace_id: str,
    environment_id: str,
    ...
    """Execute get_staging_settings command
    ...
    try:
        ...
        result = client.get_staging_settings(workspace_id=workspace_id, environment_id=environment_id)

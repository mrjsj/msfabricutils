...
def get_published_settings_command(
    *,
    workspace_id: str,
    environment_id: str,
    ...
    """Execute get_published_settings command
    ...
    try:
        ...
        result = client.get_published_settings(workspace_id=workspace_id, environment_id=environment_id)

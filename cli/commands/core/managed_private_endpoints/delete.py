...
def delete_command(
    *,
    workspace_id: str,
    managed_private_endpoint_id: str,
    ...
    try:
        ...
        result = client.delete_workspace_managed_private_endpoint(workspace_id=workspace_id, managed_private_endpoint_id=managed_private_endpoint_id)

...
def update_command(
    *,
    ...
    try:
        ...
        result = client.update_warehouse(
            workspace_id=workspace_id, warehouse_id=warehouse_id, display_name=display_name, description=description, return_item=return_item
        )

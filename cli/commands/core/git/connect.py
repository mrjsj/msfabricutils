...
def connect_command(
    *,
    workspace_id: str,
    git_provider_details: Annotated[GitProviderDetails, Parameter(name="*")],
    ...
    Args:
        ...
        git_provider_details (Annotated[GitProviderDetails, Parameter(name="*")]): The git provider details
    """

    try:
        if isinstance(git_provider_details, ComplexType):
            git_provider_details = git_provider_details.to_dict()

        from msfabricpysdkcore import FabricClientCore

        client = FabricClientCore()
        result = client.git_connect(workspace_id=workspace_id, git_provider_details=git_provider_details)
